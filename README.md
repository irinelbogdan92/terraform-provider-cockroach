# Terraform Provider: CockroachDB

The CockroachDB terraform provider can be used to setup users & databases inside a cockroachdb cluster. This is very usefull in case you use infrastructure as code.
If the cockroachdb cluster is not reachable from the machine you run the infrastructure, you can reach it using the kubeconfig file.

This is very usefull if you deploy cockroachdb in your own kubernetes infrastructure.
